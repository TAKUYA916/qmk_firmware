...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_0] = LAYOUT_ansi_82(
        ...
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     LT(9,KC_SCLN), KC_QUOT,          KC_ENT,             KC_HOME,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LCTL,  KC_LWIN,  KC_LALT,                                LT(1,KC_SPC),                           FN_3,     FN_4,     KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),

    [LAYER_1] = LAYOUT_ansi_82(
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,            UG_TOGG,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   _______,  _______,            _______,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        _______,  _______,  _______,  _______,  _______,  _______,  C(KC_Y),  KC_PGUP,  KC_UP,    KC_PGDN,  _______,  _______,  _______,  _______,            _______,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        _______,  _______,  C(KC_S),  _______,  _______,  _______,  KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_DEL,   _______,            _______,            KC_END,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
    ...
    [LAYER_2] = LAYOUT_ansi_82(
        ...
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LCTL,  XXXXXXX,  KC_LALT,                                KC_SPC,                                 FN_1,     FN_2,     KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    ...
    [LAYER_9] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_TAB,   KC_Q,     XXXXXXX,  KC_E,     KC_R,     KC_T,     KC_Y,     MS_WHLU,  KC_I,     MS_WHLD,  KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_CAPS,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_F,     KC_G,     MS_BTN4,  MS_BTN1,  MS_BTN2,  KC_L,     XXXXXXX,  KC_QUOT,            KC_ENT,             KC_HOME,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     MS_BTN5,  MS_BTN3,  KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 FN_1,     FN_2,     KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
};
...
bool rgb_matrix_indicators_user(void) {
    uint8_t layer = biton32(default_layer_state | layer_state);
...
void matrix_scan_user(void) {
    ...
    if (layer == LAYER_9) {
        uint8_t val_w = analog_matrix_get_travel(2, 2);
        uint8_t val_a = analog_matrix_get_travel(3, 1);
        ...
        uint8_t travel_w = val_w / 6;
        uint8_t travel_a = val_a / 6;
        uint8_t travel_s = val_s / 6;
        uint8_t travel_d = val_d / 6;

        if (travel_w > deadzone) move_y -= (uint16_t)travel_w * travel_w / 230;
        if (travel_s > deadzone) move_y += (uint16_t)travel_s * travel_s / 230;
        if (travel_a > deadzone) move_x -= (uint16_t)travel_a * travel_a / 230;
        if (travel_d > deadzone) move_x += (uint16_t)travel_d * travel_d / 230;
