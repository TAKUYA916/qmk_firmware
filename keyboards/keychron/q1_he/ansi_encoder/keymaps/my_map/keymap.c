...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_9] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_TAB,   KC_Q,     XXXXXXX,  KC_E,     KC_R,     KC_T,     KC_Y,     KC_WH_U,  KC_I,     KC_WH_D,  KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_CAPS,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_F,     KC_G,     KC_BTN4,  KC_BTN1,  KC_BTN2,  KC_L,     XXXXXXX,  KC_QUOT,            KC_ENT,             KC_HOME,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_BTN5,  KC_BTN3,  KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
        //-------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+
        KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 FN_1,     FN_2,     KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
};
...
void matrix_scan_user(void) {
    ...
    if (layer == LAYER_9) {
        ...
        if (val_w > deadzone) move_y -= (uint16_t)val_w * val_w / 230;
        if (val_s > deadzone) move_y += (uint16_t)val_s * val_s / 230;
        if (val_a > deadzone) move_x -= (uint16_t)val_a * val_a / 230;
        if (val_d > deadzone) move_x += (uint16_t)val_d * val_d / 230;
